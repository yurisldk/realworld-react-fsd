...
type EnsurePermissionGroupKey<F, P = PermissionGroup> = F extends keyof P ? F : never;

export type ConditionalPermissionContext<T, F> = ConditionalContext<T, EnsurePermissionGroupKey<F>>;
